...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, ArtworkComponent],
  ...
  quadres: IArtwork[] = [
    {
      ...
      catalogue_display:
        '<p>Lehrs IX.199</p><p>Bartsch VI.221.48</p><p>Geisberg 182</p><p>Hollstein XXIV.199</p>',
      ...
      is_on_view: false,
      on_loan_display:
        "<p>On loan to Chazen Museum of Art in Madison for <i>Art of Enterprise: Israhel van Meckenem's 15th-Century Print Workshop</i></p>",
      gallery_title: null,
      gallery_id: null,
      nomisma_id: null,
    ...
    },
    {
      ...
      is_on_view: false,
      on_loan_display:
        '<p>On loan to Fondation Louis Vuitton for <i>Mark Rothko</i></p>',
      gallery_title: null,
      gallery_id: null,
      nomisma_id: null,
      ...
      subject_ids: ['TM-12656', 'TM-11840', 'TM-11905', 'TM-11842', 'TM-12479'],
      subject_titles: [
        'rectangles',
        'gray (color)',
        'orange (color)',
    ...
    },
    {
      ...
      credit_line: 'Bequest of Mrs. Potter Palmer, Jr.',
      catalogue_display:
        '<p>Lehrs IX.619</p><p>Bartsch VI.282.205</p><p>Geisberg 471</p><p>Hollstein XXIV.619</p>',
      publication_history: null,
      exhibition_history: null,
      provenance_text: null,
      edition: null,
